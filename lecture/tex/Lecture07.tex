	...
	\begin{columns}
		\begin{column}{0.55\textwidth}
			...
			\begin{itemize}
				...
				\item<3-> In contrast to the IM model \figref{fig:Inductive_coupling_stator_rotor_IM}, the SM's rotor field coil is represented by a single winding.
...
\begin{frame}
	...
	\end{equation}
	\onslide<5->
	In addition, the field winding flux results in
	\begin{equation}
		\begin{split}
